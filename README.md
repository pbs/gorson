...
```
$ wget https://github.com/pbs/gorson/releases/download/4/gorson-4-darwin-amd64
```
...
Download the binary
```
$ wget https://github.com/pbs/gorson/releases/download/4/gorson-4-linux-amd64
```

Move the binary to an installation path, make it executable, and add to path
```
mkdir -p /opt/gorson/bin
mv gorson-4-linux-amd64 /opt/gorson/bin/gorson
